...
BSRC_OPS += ops_add.cc ops_mul.cc ops_scale.cc ops_gelu.cc ops_reduce.cc ops_layer_norm.cc ops_softmax.cc ops_matmul.cc ops_linear.cc ops_im2col.cc
...
USRC_OPS := ops_tensor_test.cc ops_identity_test.cc ops_reshape_test.cc ops_add_test.cc ops_mul_test.cc ops_reduce_test.cc ops_layer_norm_test.cc ops_all_reduce_test.cc ops_scale_test.cc
...
CPPSOURCES += $(shell find $(ARKDIR)/python -regextype posix-extended -regex '.*\.(c|cpp|h|hpp|cc|cxx|cu)')
