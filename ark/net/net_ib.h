...
class NetIbMr {
   public:
    ...
    void *get_mr() const { return mr; }
    void *get_buf() const { return buffer; };
    const struct Info &get_info() const { return info; };
...
class NetIbMgr {
   public:
    ...
    void *get_wcs() const { return wcs; };
    int get_wcn() const { return wcn; };
