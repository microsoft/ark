...
ark::unittest::State test_arch() {
    ...
    UNITTEST_FALSE(ark::ARCH_ROCM->belongs_to(ark::ARCH_CUDA));

    UNITTEST_TRUE(ark::ARCH_CUDA_80->belongs_to(ark::ARCH_CUDA_80));
    UNITTEST_TRUE(ark::ARCH_CUDA_90->later_than(ark::ARCH_CUDA_80));
    UNITTEST_FALSE(ark::ARCH_CUDA_80->later_than(ark::ARCH_CUDA_90));
    UNITTEST_FALSE(ark::ARCH_CUDA_80->later_than(ark::ARCH_CUDA_80));
