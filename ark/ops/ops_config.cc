...
const std::map<OpConfigKey, std::vector<OpConfig>> ARK_OP_CONFIG_MAP = {
    ...
    {{OP_REDUCE, OP_ARCH_CUDA_70, OP_PREC_FP16},
     {
         // NumWarps, SmemBytes, InDepsTiles, OutDepsTiles, SyncPre, SyncPost
         {4, 1024, {{64, 64}}, {{64, 64}}, false, false},
         {2, 1024, {{32, 64}}, {{32, 64}}, false, false},
         {1, 1024, {{16, 64}}, {{16, 64}}, false, false},
         {1, 1024, {{8, 64}}, {{8, 64}}, false, false},
         {1, 1024, {{2, 128}}, {{2, 128}}, false, false},
         {1, 1024, {{4, 64}}, {{4, 64}}, false, false},
         {1, 1024, {{2, 64}}, {{2, 64}}, false, false},
         {1, 1024, {{1, 64}}, {{1, 64}}, false, false},
     }},
