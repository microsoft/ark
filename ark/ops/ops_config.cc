...
const std::map<OpConfigKey, std::vector<OpConfig>> ARK_OP_CONFIG_MAP = {
    ...
    {{OP_REDUCE, OP_ARCH_CUDA_70, OP_PREC_FP16},
     {
         // NumWarps, SmemBytes, InDepsTiles, OutDepsTiles, SyncPre, SyncPost
         {4, 1024, {{64, 1}}, {{64, 1}}, false, false},
         {2, 1024, {{32, 1}}, {{32, 1}}, false, false},
         {1, 1024, {{16, 1}}, {{16, 1}}, false, false},
         {1, 1024, {{8, 1}}, {{8, 1}}, false, false},
         {1, 1024, {{2, 1}}, {{2, 1}}, false, false},
         {1, 1024, {{4, 1}}, {{4, 1}}, false, false},
         {1, 1024, {{2, 1}}, {{2, 1}}, false, false},
         {1, 1024, {{1, 1}}, {{1, 1}}, false, false},
     }},
