...
ark::unittest::State test_reshape_padded() {
    {
        ark::Model model;
        ark::Tensor tns0 = model.tensor({32, 64}, ark::FP32, {32, 100});
    ...
    {
        ark::Model model;
        ark::Tensor tns0 = model.tensor({2, 3, 4, 5}, ark::FP32, {3, 3, 4, 5});
    ...
    {
        ark::Model model;
        ark::Tensor tns0 = model.tensor({2, 3, 4, 5}, ark::FP32, {3, 3, 8, 5});
    ...
    {
        ark::Model model;
        ark::Tensor tns0 = model.tensor({4, 3}, ark::FP32, {4, 9}, {0, 5});
