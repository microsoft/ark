                       ...
                       ark::DimType m)
{
    string kernel_name;
    if (type == ark::FP32) {
        kernel_name = "simple_add_fp32";
    } else if (type == ark::FP16) {
        kernel_name = "simple_add_fp16";
    } else {
    ...
    ark::Tensor *tns_c = model.add(tns_a, tns_b);
    ...
    LOG(ark::INFO, "add:", n, 'x', m, ",bs=", bs, setprecision(4), " mse ",
...
{
    test_add_internal<float>(ark::FP32, 1, 1, 2);
    test_add_internal<float>(ark::FP32, 1, 1, 64);
    test_add_internal<float>(ark::FP32, 1, 128, 128);
    test_add_internal<float>(ark::FP32, 1, 1024, 512);
    test_add_internal<float>(ark::FP32, 1, 512, 1024);
    test_add_internal<float>(ark::FP32, 2, 1, 64);
    test_add_internal<float>(ark::FP32, 2, 128, 128);
    test_add_internal<float>(ark::FP32, 4, 1024, 512);
    test_add_internal<float>(ark::FP32, 4, 512, 1024);
    return ark::unittest::SUCCESS;
}

ark::unittest::State test_add_fp16()
{
    test_add_internal<ark::half_t>(ark::FP16, 1, 1, 2);
    test_add_internal<ark::half_t>(ark::FP16, 1, 1, 64);
    test_add_internal<ark::half_t>(ark::FP16, 1, 128, 128);
    test_add_internal<ark::half_t>(ark::FP16, 1, 1024, 512);
    test_add_internal<ark::half_t>(ark::FP16, 1, 512, 1024);
    test_add_internal<ark::half_t>(ark::FP16, 2, 1, 64);
    test_add_internal<ark::half_t>(ark::FP16, 2, 128, 128);
    test_add_internal<ark::half_t>(ark::FP16, 4, 1024, 512);
    test_add_internal<ark::half_t>(ark::FP16, 4, 512, 1024);
    return ark::unittest::SUCCESS;
}
