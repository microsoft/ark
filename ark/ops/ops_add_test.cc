...
{
    test_add_internal<half_t>(ark::FP16, 1, 1, 2);
    test_add_internal<half_t>(ark::FP16, 1, 1, 64);
    test_add_internal<half_t>(ark::FP16, 1, 128, 128);
    test_add_internal<half_t>(ark::FP16, 1, 1024, 512);
    test_add_internal<half_t>(ark::FP16, 1, 512, 1024);
    test_add_internal<half_t>(ark::FP16, 2, 1, 64);
    test_add_internal<half_t>(ark::FP16, 2, 128, 128);
    test_add_internal<half_t>(ark::FP16, 4, 1024, 512);
    test_add_internal<half_t>(ark::FP16, 4, 512, 1024);
    return ark::unittest::SUCCESS;
}
