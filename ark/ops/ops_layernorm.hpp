...
#ifndef ARK_OPS_LAYERNORM_HPP_
#define ARK_OPS_LAYERNORM_HPP_

#include "model/model_op.hpp"

namespace ark {

class ModelOpLayerNorm : public ModelOp {
   public:
    ModelOpLayerNorm() = default;
    ModelOpLayerNorm(ModelTensorRef input, ModelTensorRef gamma,
