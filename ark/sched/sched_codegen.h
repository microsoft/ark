...
class DefaultCodeGenerator : BaseCodeGenerator
{
  ...
  private:
    ...
    std::ostream &codegen_arg_def(std::ostream &os, const OpArg &arg, const std::string &name);
    ...
    std::ostream &codegen_uop_def(std::ostream &os, const SchedOp &sop, int uop_id);
