...
def test_softmax_internal(batch_size, m, n, data_type="float"):
    ark.init()
    ...
    # print(gt)
    print("softmax test ", "batch_size:", batch_size, "m:", m, "n:", n, "data_type:", data_type, "max error: ", max_error, "avg error: ", avg_error)
