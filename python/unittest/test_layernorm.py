...
def test_layernorm_internal(
    batch_size, m, n, data_type="float", layer_norm_type="layernorm", iter=1
):
    runtime = ark.Runtime()
    if data_type == "float":
    ...
    print(
        f"{layer_norm_type} test batch_size: {batch_size:6d} m: {m:6d} "
...
class TestLayernorm(unittest.TestCase):
    ...
    def test_rmsnorm(self):
        test_layernorm_internal(1, 32, 4, "half", "rmsnorm")
        test_layernorm_internal(1, 32, 512, "half", "rmsnorm")
        test_layernorm_internal(1, 64, 4, "half", "rmsnorm")
        test_layernorm_internal(1, 128, 128, "half", "rmsnorm")
        test_layernorm_internal(1, 256, 256, "half", "rmsnorm")
        test_layernorm_internal(1, 512, 512, "half", "rmsnorm")

        test_layernorm_internal(1, 8, 4, layer_norm_type="rmsnorm")
        test_layernorm_internal(1, 128, 128, layer_norm_type="rmsnorm")
        test_layernorm_internal(1, 256, 256, layer_norm_type="rmsnorm")
        test_layernorm_internal(1, 512, 512, layer_norm_type="rmsnorm")
        test_layernorm_internal(1, 1024, 1024, layer_norm_type="rmsnorm")
        test_layernorm_internal(1, 4096, 1024, layer_norm_type="rmsnorm")
        test_layernorm_internal(1, 1024, 4096, layer_norm_type="rmsnorm")
        test_layernorm_internal(2, 64, 64, layer_norm_type="rmsnorm")
        test_layernorm_internal(2, 128, 128, layer_norm_type="rmsnorm")
        test_layernorm_internal(8, 4096, 1024, layer_norm_type="rmsnorm")
        test_layernorm_internal(8, 1024, 4096, layer_norm_type="rmsnorm")
